...
public class AppsLoader extends AsyncTaskLoader<ArrayList<AppModel>> {
    ...
    //added in order to use with viewing package list feature in launcher
    private ArrayList<String> fullPkgList = null;
  //added in order to use with viewing app list feature in launcher
    private ArrayList<String> fullAppList = null;
    ...
    public ArrayList<AppModel> loadInBackground() {
        ...
        //TODO clear out app loading code since I am just using buttons
        // list of package names of applications I want to be shown in launcher
        List<String> whiteList = new ArrayList<String>();
//        whiteList.add("com.example.alextestapp2");
//        whiteList.add("com.hydrainsight.oefsyncparticipant");
        ...
        fullPkgList = new ArrayList<String>();
        fullAppList = new ArrayList<String>();
        for (int i = 0; i < apps.size(); i++) {
            String pkg = apps.get(i).packageName;
            
            //extracting app name from package name
            ...
            //TODO can be removed with use of AppModel class
            final String applicationName = (String) (ai != null ? pm.getApplicationLabel(ai) : "(unknown)");
            
            fullPkgList.add(pkg);
            //TODO application name already available in AppModel class
            fullAppList.add(applicationName);

            //filtering which apps to load in the launcher
    ...
    //in order to access the full package list to display in the launcher menu
  ...
  //in order to access the full app list to display in the launcher menu
